...
public class practiceQuiz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        practiceQuizmsg = (LinearLayout) practiceQuizMainView.findViewById(R.id.practiceQuizMessage);
...
//                            recyclerView.setAdapter(myAdapter);
                            ...
                            mDialog.dismiss();
                            practiceQuizMainView.setBackgroundColor(getResources().getColor(R.color.white));
                            practiceQuizmsg.setVisibility(View.VISIBLE);
